function LABELS = helperLoop(num,seed)
close all
...
for epoch = 1:numEpochs
    ...
    while hasdata(mbq)
        ...
        LABELS.("iteration"+num2str(ii)) = onehotdecode(T,[1:9,0],1);
...
save(sprintf("losses%s_%s.mat",num2str(num),seed),"losses")
end
