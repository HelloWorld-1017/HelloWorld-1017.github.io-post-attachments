...
for i = 1:nt
    ...
    b(2:end-1,2:end-1) =  ... % have no relation to the interation of p (Place here for saving computation resources)
        rho/dt*((u(3:end,2:end-1)-u(1:end-2,2:end-1))/(2*dx)+(v(2:end-1,3:end)-v(2:end-1,1:end-2))/(2*dy))...
        -(u(3:end,2:end-1)-u(1:end-2,2:end-1))/(2*dx).*(u(3:end,2:end-1)-u(1:end-2,2:end-1))/(2*dx)...
        -2*(u(2:end-1,3:end)-u(2:end-1,1:end-2))/(2*dy).*(v(3:end,2:end-1)-v(1:end-2,2:end-1))/(2*dx)...
        -(v(2:end-1,3:end)-v(2:end-1,1:end-2))/(2*dy).*(v(2:end-1,3:end)-v(2:end-1,1:end-2))/(2*dy);
