% [Rainy evening in the MATropolis - MATLAB Flipbook Mini Hack]
...
persistent handles ax
if f == 1 || isempty(handles)
    rng("default")
    ax = axes("colormap",gray,"View",[172,22],"Color","k");
    hold(ax,"on")
    ...
    b = bar3(h);
    axis equal
    g = 0.17;                  % height and width of windows
