...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&euclidean_atexit);
  /* Module initialization. */
  euclidean_initialize();
  /* Dispatch the entry-point. */
  unsafe_euclidean_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
  euclidean_terminate();
}
                                  ...
                                  const mxArray *prhs[2])
{
  ...
  /* Call the function. */
  euclidean_api(prhs, nlhs, outputs);
...
/*
 * File trailer for _coder_euclidean_mex.c
 *
 * [EOF]
 */
